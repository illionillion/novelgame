...
var endrol="企画<br>セイ・ゴマ団子<br><br>シナリオライター プロデューサー<br>ゴマ団子<br><br>プログラマー　ディレクター<br>セイ<br>音源:魔王魂<br>画像:いらすとや";
...
//配列から場面に合わせてテキストを抽出
  ...
  screen.classList.add("text_center");
  nextbtn.value='始める';
  ...
  if(sessionStorage.hasOwnProperty('page-count')){
    ...
    screen.innerHTML="<br>"+sentence[page];
    screen.classList.remove('text_center');
    if(special[0]){
      screen.innerHTML="<br>"+sentence[page-1];
...
nextbtn.onclick=function next(){
  ...
  // }
    screen.classList.remove('text_center');
    screen.classList.remove('text_center2');
    var page = page_count();
    setTimeout("sound()",1);
